...
export default function MemberManager({ embedded = false }: Props) {
  ...
  const tableShell = embedded
    ? "overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 dark:border-zinc-800 dark:bg-zinc-950/50"
  ...
  return (
    <div className={shell}>
      <form onSubmit={onSubmit} className={formShell}>
        {!embedded ? <h3 className="text-lg font-bold text-slate-900 dark:text-white">Add member</h3> : null}
        <input
      ...
      <div className={tableShell}>
        <div className={embedded ? "border-b border-slate-100 px-5 py-3 dark:border-zinc-800" : "border-b border-slate-100 bg-gradient-to-r from-slate-50 to-emerald-50/40 px-5 py-3 dark:border-zinc-800 dark:from-zinc-900 dark:to-emerald-950/20"}>
